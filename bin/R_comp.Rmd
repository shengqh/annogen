...
####################### Read in python-annotated files & derive GC% ###################
intv.ls2 <- lapply(paste( c(args[1],args[2]),'genome_anno.tsv',sep='.' ),
	function(x) {
...
newlist <- R_comp_table(intv1,intv2,c(args[1],args[2]))
```
...
R_comp_ftPlot(col.ls2,c(args[1],args[2]),subNames)
```
